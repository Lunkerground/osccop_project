...
var selectedDisplay = (gameId, gameName, consoleName) => {
  $('.choosedgame').append('<a class="removeGame selectGame" id="C' + gameId + '"><div class="game" ><p><span class="glyphicon glyphicon-remove" style="color:red"></span> <strong>' + gameName + '</strong></p></div></a>')
}
